 ...
 */
export async function getEmployeeTickets(status?: string): Promise<EmployeeTicket[]> {
 ...
 * Create new ticket
 */
export async function createEmployeeTicket(data: CreateTicketData): Promise<EmployeeTicket> {
