...
export function NotificationBell({
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      {open ? (
        <div className="absolute right-0 z-50 mt-2 w-[min(20rem,calc(100vw-1rem))] max-w-[calc(100vw-1rem)] overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-xl">
