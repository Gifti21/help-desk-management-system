    ...
    <div className="flex items-center justify-center gap-2 py-4 px-6 bg-white border-t border-slate-200">
      <button
        ...
        className={`px-3 py-1.5 text-xs font-bold tracking-wider uppercase transition-colors ${
          hasPrevious ? 'text-emerald-700 hover:text-emerald-900 cursor-pointer' : 'text-slate-300 cursor-not-allowed'
        }`}
      >
        Prev
      </button>
      ...
      <button
        ...
        disabled={!hasNext}
        className={`px-3 py-1.5 text-xs font-bold tracking-wider uppercase transition-colors ${
          hasNext ? 'text-emerald-700 hover:text-emerald-900 cursor-pointer' : 'text-slate-300 cursor-not-allowed'
        }`}
      >
        Next
      </button>
