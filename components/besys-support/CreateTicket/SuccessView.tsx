import { DARK_GREEN, TEAL_PRIMARY, PAGE_BACKGROUND, BORDER_GREY, BODY_TEXT_GREY, LIGHT_TEAL_BG } from "@/lib/colors";
      ...
      <div className="flex-1 lg:ml-[280px]">
        ...
        <main className="flex items-center justify-center p-6 lg:p-8 min-h-[calc(100vh-73px)]">
          <Card variant="elevated" className="p-8 text-center max-w-md" style={{ borderColor: BORDER_GREY }}>
            ...
            >
              <svg className="h-8 w-8" style={{ color: TEAL_PRIMARY }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            >
              Your ticket has been submitted. You will be redirected to the dashboard shortly.
            </p>
          </Card>
        </main>
      </div>
