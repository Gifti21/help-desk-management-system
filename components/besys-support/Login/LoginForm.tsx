...
import { DARK_GREEN, TEAL_PRIMARY, TEAL_HOVER, BORDER_GREY, BODY_TEXT_GREY, PRIMARY_TEXT, INPUT_BORDER, ERROR, PAGE_BACKGROUND } from "@/lib/colors";
import { HEADING_LG, BODY_REGULAR, BODY_SM, CAPTION_REGULAR, INPUT_REGULAR, FONT_FAMILY, FONT_WEIGHT } from "@/lib/fonts";
    ...
    <div className="flex-1 px-6 py-8 sm:px-8 lg:px-10 lg:py-10">
      ...
      <form className="space-y-5" onSubmit={onSubmit} noValidate>
        ...
        <div>
          ...
          <div className="flex items-center gap-3 rounded-2xl border px-4 py-3 transition focus-within:ring-2" style={{ borderColor: INPUT_BORDER, backgroundColor: PAGE_BACKGROUND, '--tw-ring-color': TEAL_PRIMARY, '--tw-ring-color-light': 'rgba(47, 217, 196, 0.2)' } as React.CSSProperties}>
            ...
            <button
              ...
              onMouseLeave={(e) => e.currentTarget.style.color = BODY_TEXT_GREY}
      ...
      >
        Don&apos;t have login details? Contact your <span className="font-semibold" style={{ color: PRIMARY_TEXT }}>BESYS account manager</span>.
      </p>
    </div>
  );
}
