...
export function HeroSection() {
  return (
    <section className="px-4 py-20 text-white sm:px-6 lg:px-8 lg:py-28" style={{ background: `linear-gradient(${HERO_GRADIENT.direction}, ${HERO_GRADIENT.start}, ${HERO_GRADIENT.middle}, ${HERO_GRADIENT.end})` }}>
