...
export function FAQSection() {
  ...
  return (
    ...
    >
      <div
        className="mx-auto max-w-5xl rounded-[32px] border bg-white p-8 shadow-sm sm:p-10"
          ...
          {faqs.map((faq, index) => {
            ...
            return (
              <FaqItem
                ...
                faq={faq}
                isOpen={isOpen}
                onToggle={() => setOpenFaq(isOpen ? -1 : index)}
              />
            );
          })}
        </div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        {isOpen ? (
          <ChevronUp className="h-5 w-5" style={{ color: TEAL_PRIMARY }} />
        ) : (
          <ChevronDown className="h-5 w-5" style={{ color: TEAL_PRIMARY }} />
        )}
      </button>
      {isOpen ? (
        <p
