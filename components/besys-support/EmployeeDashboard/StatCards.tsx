import { DARK_GREEN, TEAL_PRIMARY, BODY_TEXT_GREY, BORDER_GREY } from "@/lib/colors";
...
export function StatCards({ stats, isLoading }: StatCardsProps) {
  ...
  return (
    <>
      ...
      <StatCard label="In Progress" value={stats.inProgress} color={DARK_GREEN} />
  ...
  return (
    <div 
      ...
      onMouseEnter={(e) => {
        ...
        e.currentTarget.style.boxShadow = '0 20px 50px rgba(47, 217, 196, 0.25)';
      }}
      onMouseLeave={(e) => {
