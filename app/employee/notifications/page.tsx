...
function buildNotifications(tickets: EmployeeTicket[]): EmployeeNotification[] {
  return tickets.map((ticket) => ({
    ...
    title:
      ticket.status === "RESOLVED" || ticket.status === "CLOSED"
        ...
        : "Ticket Update",
    message: `Your ticket "${ticket.title}" is ${ticket.status.replace("_", " ").toLowerCase()}.`,
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 pb-4">
              <div>
                ...
                <p className="text-xs sm:text-sm text-slate-600 mt-1">
                  Stay updated on your ticket status, responses, and support
                  updates.
                </p>
              </div>
            ...
            <div className="flex items-center gap-2 border-b border-slate-200 pb-3">
              ...
              <button
                ...
                style={{
                  ...
                  color:
                    activeTab === "UNREAD" ? BUTTONS.primaryText : "#475569",
                }}
                className={`px-3.5 py-1.5 text-xs font-bold rounded-lg transition-colors ${
                  activeTab === "UNREAD"
                    ? ""
              ...
              {filteredNotifications.length === 0 ? (
                ...
                filteredNotifications.map((item) => (
                  <Card
                    ...
                    className={`p-4 transition-all duration-200 cursor-pointer shadow-xs hover:shadow-md ${
                      !item.read
